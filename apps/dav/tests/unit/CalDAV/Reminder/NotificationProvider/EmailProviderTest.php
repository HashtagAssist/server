...
class EmailProviderTest extends AbstractNotificationProviderTest {
	...
	public function testSendWithoutAttendees():void {
		...
		$message1 = $this->getMessageMock(['uid1@example.com'], $template1);
		$template2 = $this->getTemplateMock();
		$message2 = $this->getMessageMock(['uid2@example.com', 'uid3@example.com'], $template2);
	...
	public function testSendWithAttendees(): void {
		...
		$template1 = $this->getTemplateMock();
		$message1 = $this->getMessageMock(['foo1@example.org', 'uid2@example.com', 'uid3@example.com'], $template1);
		$template2 = $this->getTemplateMock();
		$message2 = $this->getMessageMock(['foo3@example.org', 'foo4@example.org', 'uid1@example.com'], $template2);
	 ...
	 * @return IMessage
	 */
	private function getMessageMock(array $bccList, IEMailTemplate $templateMock, array $replyTo=null):IMessage {
